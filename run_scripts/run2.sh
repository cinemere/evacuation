                    ...
                    for alpha in ${alpha_states[@]}; do
                        ...
                        for noisecoef in ${noisecoef_states[@]}; do
                            ...
                            for ensldegree in ${ensldegree_states[@]}; do
                                ...
                                echo "python main.py --exp-name $exp_name -n $n_ped --learn-timesteps $learn_timesteps -e $emb_state --is-new-exiting-reward $exitrew_state --is-new-followers-reward $follrew_state --intrinsic-reward-coef $intrrew --init-reward-each-step $initrew--alpha $alpha --noise-coef $noisecoef --enslaving-degree $ensldegree"
                                python main.py --exp-name $exp_name -n $n_ped --learn-timesteps $learn_timesteps -e $emb_state --is-new-exiting-reward $exitrew_state --is-new-followers-reward $follrew_state --intrinsic-reward-coef $intrrew --init-reward-each-step $initrew --alpha $alpha --noise-coef $noisecoef --enslaving-degree $ensldegree &
                            done
